...
@endphp
<a href="javascript:void(0)" class="d-flex align-items-center text-dark h-100 " data-toggle="dropdown" data-display="static">
    <span class="position-relative text-reset btn bg-sm btn-circle btn-icon">
        ...
        <span class="absolute-top-right" style="top: -3px;right: -3px;">
            @if(isset($cart) && count($cart) > 0)
                <span class="badge badge-primary badge-inline badge-pill text-white cart-count shadow-md" style="width: 16px;height: 16px;font-size: 8px;">{{ count($cart)}}</span>
            @else
                <span class="badge badge-primary badge-inline badge-pill text-white cart-count shadow-md" style="width: 16px;height: 16px;font-size: 8px;">0</span>
            @endif
        </span>
    </span>
</a>
