...
<section class=" border-bottom pb-3 pt-5">
                            ...
                            <div class="manage-card">
                                <div class="mb-5 d-md-flex align-items-center p-2" >
                                    ...
                                    <div class="flex-grow-1 lh-1-8 text-left ml-4 mr-4 pr-2">
                                        ...
                                        <div class="lh-1-7 fs-12 mb-2 text-justify management" id="text-{{ $key }}" >{!! json_decode(get_page_setting('management_team_details',$page->id,null,App::getLocale()),true)[$key] !!}</div>
                                       <a href="javascript:void(0)" class="text text-primary" data-id="{{ $key }}" onclick="open(this)"> <strong>Read More</strong></a>
                                    </div>
                                </div>
                            </div>
                        </div>
