	...
	<div class="card">
		...
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
                    <input type="hidden" name="types[]" value="subtitle">
					<input type="text" class="form-control" placeholder="{{translate('Subtitle')}}" name="subtitle" required>
				</div>
			</div>
			<div class="form-group row">
	...
	<div class="card">
		...
		<div class="card-body">
            <div class="form-group">
                ...
                <textarea class="aiz-text-editor form-control" name="description" data-buttons='[["font", ["bold", "underline", "italic"]],["para", ["ul", "ol"]],["view", ["undo","redo"]]]' placeholder="Type.." data-min-height="150"></textarea>
            </div>
            <div class="form-group">
                ...
                <div class="home-banner3-target">
                    ...
                    <input type="hidden" name="types[]" value="banner_text_titles">
                    <input type="hidden" name="types[]" value="banner_text_details">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" placeholder="{{translate('link with http or https')}}" name="shop_link">
				</div>
			</div>
		</div>
	</div>
