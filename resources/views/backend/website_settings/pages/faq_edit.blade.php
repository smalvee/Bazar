                    ...
                    @if (get_setting('faq_questions') != null)
                        @foreach (json_decode(get_setting('faq_questions'), true) as $key => $value)
                            <div class="row gutters-5">
                                ...
                                <div class="col-xl">
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="{{ translate('Title') }}" name="faq_questions[]" value="{{ json_decode(get_page_setting('faq_questions',$page->id,null,$lang),true)[$key] }}">
                                    </div>
                                </div>

                                <div class="col-xl">
                                    <div class="form-group">
                                        <textarea class="form-control" placeholder="" name="faq_answers[]">{{ json_decode(get_page_setting('faq_answers',$page->id,null,$lang),true)[$key] }}</textarea>
                                    </div>
                                </div>
                                <div class="col-auto">
