...
<form action="{{ route('custom-pages.update', $page->id) }}" method="POST" enctype="multipart/form-data">
	...
	<div class="card">
		...
		<div class="card-body">
            ...
            <div class="form-group row">
				<label class="col-sm-2 col-from-label" for="name">{{translate('Middle Banner')}} <span class="text-danger">*</span></label>
				<div class="col-sm-10">
					<div class="input-group " data-toggle="aizuploader" data-type="image">
						<div class="input-group-prepend">
								<div class="input-group-text bg-soft-secondary font-weight-medium">{{ translate('Browse') }}</div>
						...
						<div class="form-control file-amount">{{ translate('Choose File') }}</div>
                    	<input type="hidden" name="types[]" value="banner2">
						<input type="hidden" name="banner2" class="selected-files" value="{{ get_page_setting('banner2',$page->id) }}">
					</div>
					<div class="file-preview">
					</div>
				</div>
            ...
            <div class="form-group row">
				<label class="col-sm-2 col-from-label" for="name">{{translate('Diagram')}} <span class="text-danger">*</span></label>
				<div class="col-sm-10">
					<div class="input-group " data-toggle="aizuploader" data-type="image">
						<div class="input-group-prepend">
								<div class="input-group-text bg-soft-secondary font-weight-medium">{{ translate('Browse') }}</div>
						...
						<div class="form-control file-amount">{{ translate('Choose File') }}</div>
                    	<input type="hidden" name="types[]" value="diagram">
						<input type="hidden" name="diagram" class="selected-files" value="{{ get_page_setting('diagram',$page->id) }}">
					</div>
					<div class="file-preview">
					</div>
				</div>
	...
	<div class="card">
		...
		<div class="card-body">
            ...
            <div class="form-group row">
				<label class="col-sm-2 col-from-label" for="name">{{translate('Stages text')}} </label>
				<div class="col-sm-10">
                    <input type="hidden" name="types[][{{ $lang }}]" value="stage_text">
					<input type="text" class="form-control" placeholder="{{translate('Our “Farm to Plate” Credibility: The Seven Stages of Ensuring Safe Food')}}" name="stage_text" value="{{ get_page_setting('stage_text',$page->id,null,$lang) }}" >
				</div>
			</div>
            <div class="form-group">
