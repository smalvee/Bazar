	...
	<div class="card">
		...
		<div class="card-body">
            ...
            <div class="form-group">
                ...
                {{-- {{ dd(json_decode(get_page_setting('subsidiaries_links',$page->id), true)) }} --}}
            ...
            {{-- certifications --}}
            <div class="form-group row">
				<label class="col-sm-2 col-from-label" for="name">{{translate('Our Certifications Title')}}</label>
				<div class="col-sm-10">
                    <input type="hidden" name="types[][{{ $lang }}]" value="certification_title">
					<input type="text" class="form-control" placeholder="{{translate('Our Certifications')}}" name="certification_title" value="{{ get_page_setting('certification_title',$page->id,null,$lang) }}" >
				</div>
			</div>
            <div class="form-group">
                ...
                <textarea class="aiz-text-editor form-control" name="certification_description" data-buttons='[["font", ["bold", "underline", "italic"]],["para", ["ul", "ol"]],["view", ["undo","redo"]]]' placeholder="Type.." data-min-height="150">
                    <!--get_page_setting('our_vision',$page->id,null,$lang)-->
                    @php echo get_page_setting('certification_description',$page->id,null,$lang); @endphp
                </textarea>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea class="aiz-text-editor form-control" name="mission_description" data-buttons='[["font", ["bold", "underline", "italic"]],["para", ["ul", "ol"]],["view", ["undo","redo"]]]' placeholder="Type.." data-min-height="150">
                    ...
                    @php echo get_page_setting('mission_description',$page->id,null,$lang); @endphp
                </textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="aiz-text-editor form-control" name="vision_description" data-buttons='[["font", ["bold", "underline", "italic"]],["para", ["ul", "ol"]],["view", ["undo","redo"]]]' placeholder="Type.." data-min-height="150">
                      <!--get_page_setting('our_vision',$page->id,null,$lang)-->
                    @php echo get_page_setting('vision_description',$page->id,null,$lang); @endphp
                </textarea>
