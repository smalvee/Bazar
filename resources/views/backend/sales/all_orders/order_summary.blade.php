	...
	<div class="col-xl-6">
		<div class="pl-xl-4">
			<div class="card mb-4">
				...
				<div class="card-body">
					@if(Session::has('order_edit.shipping_info') && Session::get('order_edit.shipping_info')['name'] != null)
						<div class="d-flex justify-content-between  mb-2">
							<span class="">{{translate('Name')}}:</span>
							<span class="fw-600">{{ Session::get('order_edit.shipping_info')['name'] }}</span>
						</div>
						<div class="d-flex justify-content-between  mb-2">
							<span class="">{{translate('Phone')}}:</span>
							<span class="fw-600">{{ Session::get('order_edit.shipping_info')['phone'] }}</span>
						</div>
						<div class="d-flex justify-content-between  mb-2">
							<span class="">{{translate('Address')}}:</span>
							<span class="fw-600">{{ Session::get('order_edit.shipping_info')['address'] }}</span>
						</div>
						<div class="d-flex justify-content-between  mb-2">
							<span class="">{{translate('Country')}}:</span>
							<span class="fw-600">{{ Session::get('order_edit.shipping_info')['country'] }}</span>
						</div>
						<div class="d-flex justify-content-between  mb-2">
							<span class="">{{translate('City')}}:</span>
							<span class="fw-600">{{ Session::get('order_edit.shipping_info')['city'] }}</span>
						</div>
						<div class="d-flex justify-content-between  mb-2">
							<span class="">{{translate('Postal Code')}}:</span>
							<span class="fw-600">{{ Session::get('order_edit.shipping_info')['postal_code'] }}</span>
						</div>
					@else
