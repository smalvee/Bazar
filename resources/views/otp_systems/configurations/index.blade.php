                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('update_credentials') }}" method="POST">
                        ...
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="BULK_SMS_ID">
                            <div class="col-lg-3">
                                <label class="col-from-label">{{translate('BULK SMS ID')}}</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="BULK_SMS_ID" value="{{  env('BULK_SMS_ID') }}" placeholder="" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="BULK_SMS_PASSWORD">
                            <div class="col-lg-3">
                                <label class="col-from-label">{{translate('BULK SMS PASSWORD')}}</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="BULK_SMS_PASSWORD" value="{{  env('BULK_SMS_PASSWORD') }}" placeholder="" required>
                            </div>
                        </div>
