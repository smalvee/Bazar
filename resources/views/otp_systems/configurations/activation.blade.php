        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header">
                    <h3 class="mb-0 h6">{{translate('Bulk SMS')}}</h3>
                </div>
                <div class="card-body text-center">
                    <label class="aiz-switch aiz-switch-success mb-0">
                        <input type="checkbox" onchange="updateSettings(this, 'bulk_sms')" @if(\App\OtpConfiguration::where('type', 'bulk_sms')->first()->value == 1) checked @endif>
